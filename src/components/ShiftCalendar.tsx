...
export default function ShiftCalendar({ data, userName }: ShiftCalendarProps) {
  const calendarData = useMemo(() => {
    ...
    const firstDateObj = new Date(Number(data.year), getMonthIndex(data.month), firstDate);
    ...
    const lastDateObj = new Date(Number(data.year), getMonthIndex(data.month), lastDate);

      ...
      <div className="overflow-x-auto">
        ...
        <div className="bg-blue-100 border-l border-t border-gray-300">
          <div className="border-b border-r border-gray-300">
            <div className={`px-3 py-2 text-lg font-semibold text-gray-700 flex items-center justify-center ${(userRole === 'dealer' || userRole === 'sm' || userRole === 'operation') ? 'h-[176px]' : 'h-[216px]'}`}>
        ...
        <div className="flex border-t border-gray-300 overflow-hidden">
          ...
          >
            <div style={{ width: `${dataContentWidth}px` }}>
              <div className={`flex border-b border-gray-300 ${(userRole === 'dealer' || userRole === 'sm' || userRole === 'operation') ? 'h-[176px]' : 'h-[216px]'}`}>
